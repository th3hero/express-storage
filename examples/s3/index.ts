 ...
 * 
 * This example demonstrates direct file upload to AWS S3.
 * Files are uploaded from server to S3 bucket directly.
 * 
...
/**
 * Single file upload to S3 with validation
 */
...
app.listen(PORT, () => {
  console.log(`\n🚀 S3 Storage Server running on http://localhost:${PORT}`);
  console.log('\n📋 Available endpoints:');
  console.log('   POST   /upload          - Upload single file to S3');
  console.log('   POST   /upload-multiple - Upload multiple files to S3');
  ...
  console.log('   curl -X POST -F "file=@./test.jpg" http://localhost:3001/upload');
});
